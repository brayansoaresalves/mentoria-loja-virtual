...
class LojaVirtualMentoriaApplicationTests {
	...
	public void testRestApiDeleteAcesso() throws JsonProcessingException, Exception {
	    ...
	    ResultActions retornoApi = mockMvc
	    						 .perform(MockMvcRequestBuilders.delete("/acessos")
	    						 .content(objectMapper.writeValueAsString(acesso))
	    						 .accept(MediaType.APPLICATION_JSON)
	    						 .contentType(MediaType.APPLICATION_JSON));
	...
	public void testRestApiObterAcessoID() throws JsonProcessingException, Exception {
	    ...
	    ResultActions retornoApi = mockMvc
	    						 .perform(MockMvcRequestBuilders.get("/acessos/" + acesso.getId())
	    						 .content(objectMapper.writeValueAsString(acesso))
	    						 .accept(MediaType.APPLICATION_JSON)
	    						 .contentType(MediaType.APPLICATION_JSON));
	...
	public void testRestApiObterAcessoDesc() throws JsonProcessingException, Exception {
	    ...
	    ResultActions retornoApi = mockMvc
	    						 .perform(MockMvcRequestBuilders.get("/acessos/OBTER_LIST")
	    						 .content(objectMapper.writeValueAsString(acesso))
	    						 .accept(MediaType.APPLICATION_JSON)
	    						 .contentType(MediaType.APPLICATION_JSON));
